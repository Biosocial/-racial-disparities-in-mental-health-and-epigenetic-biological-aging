...
## Data 
Data and Scripts are saved on our group folder

## Scripts

- RaceDNAm_FFCW_000_CheckCensusdata_20230523 [Explore the FFCW data]
- RaceDNAm_FFCW_001_DataProcessing_20230718.R [Create scales of measures included in the study]
- RaceDNAm_FFCW_002_AddNeighborhood_20231005.R [Add neighborhood context as measure to the study]
- RaceDNAm_FFCW_003_AddPrenatal and prepare for MPlus_20230911.R [Add prenatal variables to the study]
- RaceDNAm_FFCW_004_LCM in Mplus_Race and DNAm_20231201 [Latent change model to test effect of race on change in DNAm, in Mplus]
- RaceDNAm_FFCW_004_LCM in Mplus_Mental Health and DNAm_20231201 [Latent change model to test associations change in mental health and change in DNAm in Mplus]
- RaceDNAm_FFCW_005_Effect Size Plots Manuscript_20231201.R [List effect sizes needed for DNAm plots in manuscript]
- RaceDNAm_FFCW_005_Plots Manuscript_20231201.R [Make plots DNAm for manuscript]
- RaceDNAm_FFCW_006_Plotting_MentalHealth_20241107 [Make plots Mental Health for manuscript]


## Authors and acknowledgment
Muna Aikins, Yayouk Willems, Deniz Fraemke, Colter Mitchel, Bridget Goosby & Laurel Raffington
